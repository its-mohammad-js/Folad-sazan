...
function HeroSection() {
  ...
  return (
    <div className="h-[600px] relative z-0 flex items-center justify-center overflow-hidden">
      ...
      {/* figures */}
      <>
        <div className="size-36 absolute z-0 left-[-15%]  md:left-[5%] top-[10%] [&>img]:animate-float-bubble [&>img]:[animation-delay:0s]">
          <img src="/images/Figures (1).png" alt="Figure-model" />
        </div>

        <div className="size-36 absolute z-0 top-12 md:top-auto left-[25%] md:left-[10%] [&>img]:animate-float-bubble [&>img]:[animation-delay:1.2s]">
          <img src="/images/Figures (1).svg" alt="Figure-model" />
        </div>

        <div className="size-36 absolute z-0 left-[-15%]  md:left-[5%] bottom-[5%] [&>img]:animate-float-bubble [&>img]:[animation-delay:2.4s]">
          <img src="/images/Figures (2).png" alt="Figure-model" />
        </div>

        <div className="size-36 absolute z-0 right-[-15%] md:right-[5%] top-[10%] [&>img]:animate-float-bubble [&>img]:[animation-delay:0.8s]">
          <img src="/images/Figures (3).png" alt="Figure-model" />
        </div>

        <div className="size-36 absolute z-0 bottom-0 md:bottom-auto right-[25%] md:right-[10%] [&>img]:animate-float-bubble [&>img]:[animation-delay:1.6s]">
          <img src="/images/Figures (4).png" alt="Figure-model" />
        </div>

        <div className="size-36 absolute z-0 -right-[15%] md:right-[5%] bottom-[5%] [&>img]:animate-float-bubble [&>img]:[animation-delay:3s]">
