  ...
  return (
    ...
    >
      ...
      <div className="h-full text-center relative md:px-16 w-full md:w-1/2 z-10 gap-4 flex items-center justify-center flex-col px-12 md:pt-12">
        <div className="size-64 rounded-xl bg-gradient-to-l from-[#C026D3] to-[#612368] -top-6 md:top-auto -rotate-12 ltr:-left-20 absolute md:ltr:-left-56 md:rtl:-right-56 z-0"></div>
        <div className="size-64 rounded-xl bg-gradient-to-l from-[#9333EA] to-[#4A00E0] -top-6 md:top-auto -rotate-6 absolute md:ltr:-left-56 md:rtl:-right-56"></div>
        ...
        <img src="/images/RoundedLine.svg" className="w-[25rem]" />
      </div>
      {/* thumbnail */}
